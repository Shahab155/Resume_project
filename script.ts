...
const resumeContainer = document.querySelector(".resumeContainer") as HTMLDivElement;
...
const mainHeading = document.querySelector(".mainHeading") as HTMLHeadingElement;
...
const displayRoleHeading = document.getElementById("displayRoleHeading") as HTMLHeadingElement;
const displayRoleSpan = document.getElementById("displayRoleSpan") as HTMLSpanElement;
const displayExperience = document.getElementById("displayExperience") as HTMLSpanElement;
const displayAge = document.getElementById("displayAge") as HTMLParagraphElement;
const dateOfBirth = document.getElementById("displayDOB") as HTMLParagraphElement;
const displayNationality = document.getElementById("displayNationality") as HTMLParagraphElement;
const displayCityParagraph = document.getElementById("displayCityParagraph") as HTMLParagraphElement;
const displayCitySpan = document.getElementById("displayCitySpan") as HTMLSpanElement;
const displayProvince = document.getElementById("displayProvince") as HTMLParagraphElement;
const displayProjects = document.getElementById("displayProjects") as HTMLSpanElement;
const displayfoundation = document.getElementById("displayFoundation") as HTMLSpanElement;
const schoolName = document.getElementById("schoolName") as HTMLParagraphElement;
const collegeName = document.getElementById("collegeName") as HTMLParagraphElement;
const universityName = document.getElementById("universityName") as HTMLParagraphElement;
const departmentName = document.getElementById("departmentName") as HTMLParagraphElement;
...
form.addEventListener("submit", async (event:SubmitEvent) => {
    ...
    const foundation = (document.getElementById("foundation") as HTMLInputElement).value
...
(document.getElementById("name") as HTMLInputElement).value = displayName.innerText || "";
(document.getElementById("email") as HTMLInputElement).value = displayEmail.innerText || "";
(document.getElementById("phone") as HTMLInputElement).value = displayPhone.innerText || "";
(document.getElementById("age") as HTMLInputElement).value = displayAge.innerText ;
(document.getElementById("experience") as HTMLInputElement).value = displayExperience.innerText || "";
(document.getElementById("projects") as HTMLInputElement).value = displayProjects.innerText || "";
(document.getElementById("role") as HTMLInputElement).value = displayRoleHeading.innerText || "";
(document.getElementById("dob") as HTMLInputElement).value = dateOfBirth.innerText || "";
}
(document.getElementById("school") as HTMLInputElement).value = schoolName.innerText || "";
(document.getElementById("college") as HTMLInputElement).value = collegeName.innerText || "";
(document.getElementById("uni") as HTMLInputElement).value = universityName.innerText || "";
(document.getElementById("department") as HTMLInputElement).value = departmentName.innerText || "";
(document.getElementById("startYear") as HTMLInputElement).value = yearFrom.innerText || "";
(document.getElementById("endYear") as HTMLInputElement).value = yearTo.innerText || ""


  // now add functionality to make resume shareable 
  const copyLinkButton = document.getElementById("linkButton") as HTMLButtonElement;
...
const addSkillsButton = document.getElementById("addSkillButton") as HTMLButtonElement;
const deleteSkillButton = document.getElementById("deleteSkillButton") as HTMLButtonElement;
